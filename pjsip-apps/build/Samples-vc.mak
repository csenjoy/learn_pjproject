...
SDL2_LIB = ..\..\third_party\SDL2\lib\$(TARGETEX)\sdl2.lib
FFMPEG_LIB = ..\..\third_party\ffmpeg\lib\avcodec.lib ..\..\third_party\ffmpeg\lib\avformat.lib ..\..\third_party\ffmpeg\lib\avutil.lib ..\..\third_party\ffmpeg\lib\swscale.lib

THIRD_PARTY_LIBS = $(GSM_LIB) $(ILBC_LIB) $(RESAMPLE_LIB) \
		   $(SPEEX_LIB) $(SRTP_LIB) $(G7221_LIB) $(BASECLASSES_LIB) \
		   $(YUV_LIB) $(WEBRTC_LIB) $(SDL2_LIB) $(FFMPEG_LIB) 
